...
public class UserSecurity implements UserDetails, CredentialsContainer {
	 ...
	 */
	public UserSecurity(String username, String password,Long customerId,Collection<? extends GrantedAuthority> authorities) {
	...
	public static class UserBuilder {
		...
		public UserDetails build() {
			...
			return new UserSecurity(username, encodedPassword, !disabled, !accountExpired,!credentialsExpired, !accountLocked, authorities);
		}
	}
}
